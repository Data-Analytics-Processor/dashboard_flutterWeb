// lib/pages/finance/subPages/costSheetJUD.dart
import 'package:flutter/material.dart';
import '../../../../models/finance_reports_model.dart';

class CostSheetJUDTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (data.isEmpty) return const Center(child: Text("No JUD Cost Sheet data found.", style: TextStyle(color: _textGrey, fontSize: 16)));
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  const Text("JUD Cost Sheet", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: _textWhite)),
                  Container(
