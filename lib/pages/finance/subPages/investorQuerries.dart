// lib/pages/finance/subPages/investorQueries.dart
import 'package:flutter/material.dart';
import '../../../../models/finance_reports_model.dart';

class InvestorQueriesTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (data.isEmpty) return const Center(child: Text("No Investor Queries data found.", style: TextStyle(color: _textGrey, fontSize: 16)));
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  const Text("Investor Queries", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: _textWhite)),
                  Container(
                ...
                child: ClipRRect(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: DataTable(
                      ...
                      columns: [
                        const DataColumn(label: Text("Query / Particular")),
