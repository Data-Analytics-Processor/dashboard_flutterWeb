...
class ProfitLossBalSheetTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (data.isEmpty) return const Center(child: Text("No P&L / Balance Sheet data found.", style: TextStyle(color: _textGrey, fontSize: 16)));
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  const Text("PL & BS Status", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: _textWhite)),
                  Container(
