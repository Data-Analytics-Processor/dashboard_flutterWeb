            ...
            child: ListView(
              ...
              children: [
                ...
                const Text(
                  ...
                  style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: _textBlack, letterSpacing: -0.5),
                ),
                const SizedBox(height: 8),
                const Text(
                  "Select a department portal to continue.",
                  textAlign: TextAlign.center,
                  style: TextStyle(fontSize: 15, color: _textGrey, fontWeight: FontWeight.w500),
                ),
                const SizedBox(height: 48),

                // Map over the user's job roles and build a card for each
                ...user.jobRoles.map((role) => Padding(
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => getDepartmentHomePage(role, user)),
                        );
                      },
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              child: Icon(_getIconForRole(role), color: _primaryNavy, size: 28),
                            ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: const TextStyle(color: _textBlack, fontSize: 16, fontWeight: FontWeight.bold),
                                  ),
                            ...
                            const Icon(Icons.arrow_forward_ios_rounded, size: 16, color: _textGrey),
                          ],
                        ),
                      ),
                    ),
