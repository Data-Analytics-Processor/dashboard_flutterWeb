// lib/pages/process/subPages/dailyStatusReports.dart
import 'package:flutter/material.dart';
import '../../../../models/process_reports_model.dart';
import '../../../components/data_table_reusable.dart';

class DailyStatusReportsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (data.isEmpty) {
      return const Center(
        child: Text("No Daily Status data found.", style: TextStyle(color: _textGrey, fontSize: 16)),
      );
    }
