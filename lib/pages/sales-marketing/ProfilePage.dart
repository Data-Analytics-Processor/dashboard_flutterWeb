                    ...
                    children: [
                      ...
                      _ProfileRow(
                        ...
                        value: user.jobRoles.isNotEmpty
                            ? user.jobRoles.map((r) => r.replaceAll('-', ' ').toUpperCase()).join(', ')
                            : "General",
                      ),
                      const Divider(color: _borderColor),
                      _ProfileRow(
                ...
                Container(
                  ...
                  child: ExpansionTile(
                    ...
                    leading: Container(
                      ...
                      child: const Icon(Icons.shield_outlined, color: _primaryAccent),
                    ),
                    title: const Text(
                      'Privacy & Security',
                      style: TextStyle(
                    ...
                    children: [
                      ListTile(
                        ...
                        trailing: const Icon(Icons.open_in_new, color: _textGrey, size: 16),
...
class _ProfileRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          // --- ICON CONTAINER (gives structure, not just floating icon) ---
          Container(
            padding: const EdgeInsets.all(8),
            decoration: BoxDecoration(
            ...
            child: Icon(
              icon,
              size: 18,
              color: ProfilePage._primaryAccent,
            ),
          ),
