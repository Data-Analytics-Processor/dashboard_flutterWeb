// lib/pages/purchase/subPages/monthlyImportantMaterials.dart
import 'package:flutter/material.dart';
import '../../../../models/purchase_reports_model.dart';
import '../../../components/data_table_reusable.dart';

class MonthlyImportantMaterialsTab extends StatelessWidget {
  ...
  const MonthlyImportantMaterialsTab({
    super.key,
    required this.data,
  ...
  Widget build(BuildContext context) {
    ...
    if (data.isEmpty) {
      return const Center(
        child: Text("No Monthly Important Materials data found.", style: TextStyle(color: _textGrey, fontSize: 16)),
      );
    }
      ...
      child: RefreshIndicator(
        ...
        child: SingleChildScrollView(
          ...
          child: ReusableDataTable<PurchaseMaterialRow>(
            title: "Monthly Important Materials",
